...
public interface AdminApi {
    ...
    @PUT(AppConstants.api+"/lets-eat/product/update")
    Call<Product> updateProduct(
            @Query("productId") int id,@Body Product product
    );

    @DELETE(AppConstants.api+"/lets-eat/product/delete")
    Call<Product> deleteProduct(
            @Query("productId") int id
    );

    @POST(AppConstants.api+"/lets-eat/staff/add")
    Call<Staff> addStaff(@Body Staff staff);

    @GET(AppConstants.api+"/lets-eat/staff/get-all")
    Call<List<Staff>> getAllStaff();

    @GET(AppConstants.api+"/lets-eat/staff/get")
    Call<Staff> getSingleStaff(
            @Query("staffId") int id
    );

    @PUT(AppConstants.api+"/lets-eat/staff/update")
    Call<Staff> updateStaff(
            @Query("staffId") int id,@Body Staff staff
    );

    @DELETE(AppConstants.api+"/lets-eat/staff/delete")
    Call<String> deleteStaff(
            @Query("staffId") int id
    );

    @PUT(AppConstants.api+"/lets-eat/admin/update-password-by-email")
    Call<Admin> updatePasswordByEmail(
            @Query("email") String mail ,@Query("password") String pass
    );

    @GET(AppConstants.api+"/lets-eat/admin/verify-email")
    Call<String> verifyEmailForForgetPass(
            @Query("email") String mail
    );

    @POST(AppConstants.api+"/lets-eat/delivery-boy/add")
    Call<deliveryBoy> addDeliveryBoy(@Body deliveryBoy boy);

    @GET(AppConstants.api+"/lets-eat/delivery-boy/get-all")
    Call<List<deliveryBoy>> getAllDeliveryBoy();

    @GET(AppConstants.api+"/lets-eat/delivery-boy/get")
    ...
    @PUT(AppConstants.api+"/lets-eat/delivery-boy/update")
    Call<deliveryBoy> updateDeliveryBoy(
            @Query("deliveryBoyId") int id,@Body deliveryBoy boy
    );

    @DELETE(AppConstants.api+"/lets-eat/delivery-boy/delete")
    Call<String> deleteDeliveryBoy(
            @Query("deliveryBoyId") int id
    );
    @GET(AppConstants.api+"/lets-eat/orders/get-all")
    ...
    @GET(AppConstants.api+"/lets-eat/payment/get-all-users-total")
    ...
    @GET(AppConstants.api+"/lets-eat/payment/get-all")
    ...
    @GET(AppConstants.api+"/lets-eat/orders/get-by-state")
    Call<List<Order>> getOrderByState(
            @Query("state")  int state
    );

    @GET(AppConstants.api+"/lets-eat/orders/get-by-delivery-boy-id")
    Call<List<Order>> getOrderByDeliveryBoyId(
            @Query("deliveryId") int id
    );

    @GET(AppConstants.api+"/lets-eat/staff/search")
    Call<List<Staff>> searchStaff(
            @Query("keyword") String s
    );

    @GET(AppConstants.api+"/lets-eat/delivery-boy/search")
    Call<List<deliveryBoy>> searchDelivery(
            @Query("keyword") String s
    );

    @POST(AppConstants.api+"/lets-eat/discount-code/add")
    Call<PromoCode> setCode(@Body PromoCode promoCode);

    @DELETE(AppConstants.api+"/lets-eat/discount-code/delete")
    Call<String> deleteCode(
            @Query("discountCodeId") int id
    );

    @GET(AppConstants.api+"/lets-eat/orders/get-by-state-and-delivery-boy-id")
    Call<List<Order>> getOrderByStateAndDeliveryBoyId(
            @Query("state") int state,@Query("deliveryBoyId") int id
    );

    @GET(AppConstants.api+"/lets-eat/discount-code/get-all")
